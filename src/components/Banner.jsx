    ...
    return (
        <div className="w-screen relative  flex flex-col items-center justify-center  ">
           ...
           <FlyingIcons text="User likes" position={{left:'10%' , bottom:'10%'}} icon={`fas fa-thumbs-up`}/>
            ...
            <div className="absolute   bg-red-400" style={{left:'21%', top:'22%', width:'70%', height:"77%"}}>
                <img src={"https://menukome.s3.amazonaws.com/menupresent.gif"} alt={Demo} className="w-full"/>
